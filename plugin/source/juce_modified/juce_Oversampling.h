...
class JUCE_API  OversamplingDownsampling
{
public:
    ...
    */
    explicit OversamplingDownsampling (size_t numChannels = 1);
    ...
    */
    OversamplingDownsampling (size_t numChannels,
                  size_t factor,
                  FilterType type,
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OversamplingDownsampling)
};
