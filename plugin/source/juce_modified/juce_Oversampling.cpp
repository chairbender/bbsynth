...
*/
/*
  Modified by Kyle Hipke for BBSynth

  Changes made:
    - Ability to downsample already oversampled input via getUnprocessedUpsampleBlock
    - Renamed to OversamplingDownsampling avoid conflict
...
struct OversamplingDownsampling<SampleType>::OversamplingStage
{
...
*/
template <typename SampleType>
struct OversamplingDummy final : public OversamplingDownsampling<SampleType>::OversamplingStage
{
    using ParentType = typename OversamplingDownsampling<SampleType>::OversamplingStage;
...
*/
template <typename SampleType>
struct Oversampling2TimesEquirippleFIR final : public OversamplingDownsampling<SampleType>::OversamplingStage
{
    using ParentType = typename OversamplingDownsampling<SampleType>::OversamplingStage;
...
*/
template <typename SampleType>
struct Oversampling2TimesPolyphaseIIR final : public OversamplingDownsampling<SampleType>::OversamplingStage
{
    using ParentType = typename OversamplingDownsampling<SampleType>::OversamplingStage;
...
//==============================================================================
template <typename SampleType>
OversamplingDownsampling<SampleType>::OversamplingDownsampling (size_t newNumChannels)
...
template <typename SampleType>
OversamplingDownsampling<SampleType>::OversamplingDownsampling (size_t newNumChannels, size_t newFactor,
...
template <typename SampleType>
OversamplingDownsampling<SampleType>::~OversamplingDownsampling()
{
    stages.clear();
}
...
//==============================================================================
template <typename SampleType>
void OversamplingDownsampling<SampleType>::addDummyOversamplingStage()
{
    stages.add (new OversamplingDummy<SampleType> (numChannels));
}

template <typename SampleType>
void OversamplingDownsampling<SampleType>::addOversamplingStage (FilterType type,
...
template <typename SampleType>
void OversamplingDownsampling<SampleType>::clearOversamplingStages()
{
    stages.clear();
...
//==============================================================================
template <typename SampleType>
void OversamplingDownsampling<SampleType>::setUsingIntegerLatency (bool useIntegerLatency) noexcept
{
    shouldUseIntegerLatency = useIntegerLatency;
}

template <typename SampleType>
SampleType OversamplingDownsampling<SampleType>::getLatencyInSamples() const noexcept
{
...
template <typename SampleType>
SampleType OversamplingDownsampling<SampleType>::getUncompensatedLatency() const noexcept
{
...
template <typename SampleType>
size_t OversamplingDownsampling<SampleType>::getOversamplingFactor() const noexcept
{
...
//==============================================================================
template <typename SampleType>
void OversamplingDownsampling<SampleType>::initProcessing (size_t maximumNumberOfSamplesBeforeOversampling)
{
...
template <typename SampleType>
void OversamplingDownsampling<SampleType>::reset() noexcept
{
    jassert (! stages.isEmpty());
...
template <typename SampleType>
AudioBlock<SampleType> OversamplingDownsampling<SampleType>::processSamplesUp (const AudioBlock<const SampleType>& inputBlock) noexcept
{
    jassert (! stages.isEmpty());
...
template <typename SampleType>
void OversamplingDownsampling<SampleType>::processSamplesDown (AudioBlock<SampleType>& outputBlock) noexcept
{
    jassert (! stages.isEmpty());
...
template <typename SampleType>
void OversamplingDownsampling<SampleType>::updateDelayLine()
{
    auto latency = getUncompensatedLatency();
...
template class OversamplingDownsampling<float>;
template class OversamplingDownsampling<double>;
